...
public class BootStrapDataApp {
	...
	public void loadUser(ApplicationReadyEvent event) {
		...
		User student = new User("student",this.passwordEncoder.encode("student"));
		User teacher = new User("teacher",this.passwordEncoder.encode("teacher"));
	...
	public void loadStudents(ApplicationReadyEvent event) {
		...
		Student s1 = new Student("Shubh","Arora","B.Tech","India");
		Student s2 = new Student("Kim", "Kard","Science","Japan");
		Student s3 = new Student("Punit","Aggarwal","B.Sc","India");
		Student s4 = new Student("Daniel","Richards","B.Arch","USA");
		Student s5 = new Student("Emma","Watson","B.Arch","England");
		Student s6 = new Student("Jeon","Jungkook","Arts","SouthKorea");
		Student s7 = new Student("Shaurya","Arora","B.Tech","India");
